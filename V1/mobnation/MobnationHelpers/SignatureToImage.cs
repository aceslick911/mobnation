...
namespace MobnationHelpers
{
    ...
    public class SignatureToImage
    {
        ...
        public Bitmap SigJsonToImage( List<SigData> sigData )
        {
        ...
        public MemoryStream SigJsonToStream(List<SigData> sigData)
        {
            var img = SigJsonToImage(sigData);
            MemoryStream mem = new MemoryStream();
            img.Save(mem, ImageFormat.Png);
            return mem;
        }

        public void SigJsonToFile(List<SigData> sigData, string aFilename)
        {
            var img = SigJsonToImage(sigData);
